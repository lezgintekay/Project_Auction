...
namespace Project_Auction_Data_Access.Migrations
{
    ...
    [Migration("20240528102012_changeBidStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_Auction_Data_Access.Domain.Bid", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Project_Auction_Data_Access.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Project_Auction_Data_Access.Domain.Bid", b =>
                {
                    b.HasOne("Project_Auction_Data_Access.Models.ApplicationUser", "User")
                        .WithMany("Bids")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project_Auction_Data_Access.Domain.Vehicle", "Vehicle")
                        .WithMany("Bids")
            ...
            modelBuilder.Entity("Project_Auction_Data_Access.Domain.Vehicle", b =>
                {
                    b.HasOne("Project_Auction_Data_Access.Models.ApplicationUser", "Seller")
                        .WithMany("Vehicles")
